class CustomerPage {
  ...
  constructor() {
    ...
    this.server = "https://localhost:7122/api"
    this.url = this.server + "/customers";
 /// this is what  connects to the API above
    ...
    ///ABove is used for the UI of the application, that will connect to the CRUD call. 
  ...
  //the actual fetch is listed below. 
  fetchStates() {
